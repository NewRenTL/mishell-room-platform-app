...
export default function MessagesPage() {
  ...
  return (
    <div className="absolute inset-x-0 top-0 bottom-16 flex flex-col bg-ink-50">
      {/* Header */}
      ...
      {/* Messages */}
      <div className="flex-1 min-h-0 overflow-y-auto bg-ink-50 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <div className="min-h-full flex flex-col gap-1 px-4 py-4">
          {loading ? (
      ...
      <div className="px-4 py-3 bg-white border-t border-ink-100 flex items-end gap-2">
        <textarea
          ...
          className="flex-1 border border-ink-200 rounded-2xl px-4 py-2.5 text-sm text-ink-900 placeholder:text-ink-400 focus:outline-none focus:border-mishell-600 resize-none max-h-28 overflow-y-auto bg-ink-50 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          onInput={(e) => {
